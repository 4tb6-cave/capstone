...
\begin{document}
	...
	\section{Introduction}
		The goal of this project is to create a potable device that can reliably and accurately reconstruct 3-D mappings of low light environments, such as crevice caves in the Niagra Escarpment, while avoiding the use of expensive technologies and solutions such as a 3-D LiDAR.
		\subsection{Purpose}
	...
	\section{System Hardware Components}
		...
		\subsubsection{Inputs and Outputs}
			...
			\begin{tabularx}{\textwidth}{X X X p{0.45\textwidth}}
				...
				Output & Capture Data & TBD & Database of captured information from a recording session \\
		...
		\subsubsection{Behavior}
			Takes in power and the various sensor signals and routes them to the software running on the Pi’s system-on-chip. The software will provide appropriate outputs to control the sensors and drive the various GPIO. 
...
\begin{figure}[H]
		...
		\subsubsection{Electrical Interfaces}
			Refer to Raspberry Pi RP1 Peripherals. 
	...
	\subsection{ToF Sensor}
		...
		\subsubsection{Inputs and Outputs}
			...
			\end{tabularx}
		\subsubsection{Behavior}
			This sensor measures the distance between itself and the environment around it and produces a series of point clouds representing a capture at a certain time instant. The interval between these captures is to be controlled by the data collection software subsystem (S1-M1). 
		\subsubsection{Dimensions}
\begin{figure}[H]
				\centering
...
\begin{figure}[H]
	...
	\subsection{IMU}
		...
		\subsubsection{Inputs and Outputs}
			...
			\end{tabularx}
		\subsubsection{Behavior}
			The IMU is a 9-axis sensor that will be used to determine displacement and rotation during scans. It produces fused data from a gyroscope, accelerometer, and geomagnetic sensor to produce matrices that represent displacements and rotations through the 3-D scanning area. 
		\subsubsection{Dimensions}
...
\begin{figure}[H]
	...
	\subsection{2D Li-DAR}
		...
		\subsubsection{Inputs and Outputs}
			...
			\end{tabularx}
		\subsubsection{Behavior}
			Scans a 2-D slice by rotating 360 degrees with a range of 0.05-12m and 0.54deg resolution. Provides an additional point cloud that will be used to help merge the more detailed 3-D scans from the ToF sensors. 
		\subsubsection{Dimensions}
